/**
 * Mobil `BrowseCategory.all` ile aynı sıra ve içerik (tek kaynak).
 * `steamHeaderIds`: Steam mağaza header görseli (kolaj / yedek) — store_item_assets.
 * `blurb`: kategori kutusunda kısa açıklama (web).
 */
module.exports = [
  {
    keyEn: "Action",
